...
⑩ `geosite:proxy` 源采用 [Loyalsoldier/domain-list-custom](https://github.com/Loyalsoldier/domain-list-custom/tree/release)（geolocation-!cn.txt，添加 `googleapis.cn` 使 Google Play Store 能够正常下载或升级应用）  
